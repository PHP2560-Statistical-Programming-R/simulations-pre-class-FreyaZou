...
game3<- function(nn, start, bankroll, bet, increment){
  ...
  return(c(bankroll,output[i]))
}
x2 <- game3(10000,0.48,1000,100,0.01)
x3 <- replicate(100, game3(1000,0.48,1000,100,0.01)[2])
exp_p <- mean(x3) 
...
```{r}
x6 <- game3(1000, 0.48, 1000, 100, 0.02)
exp_p2 <- mean(replicate(100,x6[2]))
# when increment is near 0.02, the expectation of propability to win is almost 0.5
```
